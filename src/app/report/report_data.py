...
def generate_file_report_path(output_path: Path, image_name: str, file_extension: str, file_name: str) -> str:
    ...
    """
    if output_path is not None and image_name is not None and file_extension is not None and file_name is not None:
...
def generate_image_extensions_data(image_overview_data: ImageOverviewData, image: Image, output_path: Path, session: Session) -> List[ImageExtensionsData]:
    """
